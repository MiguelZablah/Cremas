var langObj = { // eslint-disable-line
	es: {
		...
		triviaObj: [
			...
			{
				question: '¿Que te preocupa de tu piel?',
				answers: {
					a: 'Firmeza',
					b: 'Arrugas',
					c: 'Manchas de edad',
					d: 'Líneas de expresión'
				},
				correctAnswer: 'f'
				// correctMessage: 'Correct Message',
				// wrongMessage: 'Wrong Message'
			...
			{
				question: '¿Con que frecuencia usas protector solar?',
				answers: {
					a: 'A veces',
					b: 'Nunca',
					c: 'A diario',
			...
			{
				question: '¿Tu piel reacciona al medio ambiente?',
				answers: {
					a: 'No pasa nada',
					b: 'Se enrojece',
					c: 'Sensible a factores externos',
					d: 'Se irrita y pica'
				},
				correctAnswer: 'f'
				// correctMessage: 'Correct Message',
